...
class Addproducts(Form):
    ...
    image_1 = FileField('Image 1', validators=[FileRequired(), FileAllowed(['jpg','png','gif','jpeg'], 'Only images with the extensions: jpg, png, gif, jpeg are allowed.')])
    image_2 = FileField('Image 2', validators=[FileRequired(), FileAllowed(['jpg','png','gif','jpeg'], 'Only images with the extensions: jpg, png, gif, jpeg are allowed.')])
    image_3 = FileField('Image 3', validators=[FileRequired(), FileAllowed(['jpg','png','gif','jpeg'], 'Only images with the extensions: jpg, png, gif, jpeg are allowed.')])
